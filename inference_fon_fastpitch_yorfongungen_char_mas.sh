...
: ${FASTPITCH:="/media/phifamin/DATA/mebenit/test2/train_fastspeech_mas_only/FastPitchMultiwav_checkpoint_100.pt"}
: ${BATCH_SIZE:=1}
#: ${PHRASES:="phrases/devset10.tsv"}
: ${OUTPUT_DIR:="/media/phifamin/DATA/mebenit/test2/fastpitch-mas-only-test/"}
