...
: ${OUTPUT_DIR:="/media/phifamin/DATA/mebenit/test2/train_fastspeech_conv_soft3_2gengbegungbe2h2"}
...
: ${AMP:=false}
: ${SEED:=""}
: ${CHECKPOINT_PATH:="/media/phifamin/DATA/mebenit/test2/train_fastspeech_conv_soft3_2/FastPitchMultiwav_checkpoint_225.pt"}
#: ${VARIANT:=TACOTRON2}
: ${LEARNING_RATE:=0.01}
...
#: ${TRAIN_META:=/media/phifamin/DATA/mebenit/test2/metadata_fon_gun_yor_mina_cmu_train.csv}
#: ${TRAIN_META:=/media/phifamin/DATA/mebenit/test2/metadata_fongbe_cmu_trainsmall.csv}
#: ${TRAIN_META:=/media/phifamin/DATA/mebenit/test2/metadata_fon_gun_yor_mina_cmu_train.csv}
#: ${TRAIN_META:=/media/phifamin/DATA/mebenit/test2/metadata_gengbe_gungbe_1h_x2_cmu_train.csv}
#: ${TRAIN_META:=/media/phifamin/DATA/mebenit/test2/metadata_gengbe_gungbe_2h_x2_cmu_train.csv}
: ${TRAIN_META:=/media/phifamin/DATA/mebenit/test2/metadata_gengbe_gungbe_2h_x2_2_cmu_train.csv}
...
#metadata_yorubasmall_cmu_train.csv
#metadata_yoruba_cmu_train.csv
#metadata_fongbe_cmu_trainsmall.csv
#metadata_fongbe_cmu_train.csv
#metadata_gengbe_gungbe_1h_x2_cmu_train.csv
#metadata_gengbe_gungbe_2h_x2_cmu_train.csv
#metadata_gungbe_1h_cmu_train.csv
#metadata_gengbe_gungbe_15mn_x2_cmu_train.csv
...
#metadata_gengbe_30mn_cmu_train.csv
#metadata_gengbe_3h_cmu_train.csv
#metadata_gengbe_gungbe_cmu_train.csv
...
PYTHONPATH='.'  python $DISTRIBUTED train_me_char_wav.py $ARGS "$@"
