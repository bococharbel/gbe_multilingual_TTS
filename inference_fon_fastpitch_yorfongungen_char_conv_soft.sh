...
: ${FASTPITCH:="/media/phifamin/DATA/mebenit/test2/train_fastspeech_conv_soft3/FastPitchMultiwav_checkpoint_500.pt"}
: ${BATCH_SIZE:=1}
#: ${PHRASES:="phrases/devset10.tsv"}
: ${OUTPUT_DIR:="/media/phifamin/DATA/mebenit/test2/fastpitch-conv-soft-test3/"}
