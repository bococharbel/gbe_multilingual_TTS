...
: ${BATCH_SIZE:=8}
: ${GRAD_ACCUMULATION:=2}
: ${OUTPUT_DIR:="/scratch/roseline/dump/DumpFongbefrall/fastpitchoutputchar"}
#: ${OUTPUT_DIR:="./output"}
...
: ${AMP:=false}
: ${SEED:=""}
#: ${CHECKPOINT_PATH:="/scratch/roseline/dump/DumpFongbefrall/fastpitchoutputchar/FastPitchMulti_checkpoint_1.pt"}
#: ${VARIANT:=TACOTRON2}
: ${LEARNING_RATE:=0.01}
