...
: ${BATCH_SIZE:=8}
: ${GRAD_ACCUMULATION:=2}
: ${OUTPUT_DIR:="/scratch/roseline/dump/DumpFongbefrall/fastspeechoutputchar"}
#: ${OUTPUT_DIR:="./output"}
...
: ${AMP:=false}
: ${SEED:=""}
#: ${CHECKPOINT_PATH:="/scratch/roseline/dump/DumpFongbefrall/fastspeechoutputchar/FastPitch_checkpoint_80.pt"}
...
: ${TRAIN_META:=/scratch/roseline/dump/DumpFongbefrall/train/metadata_train.csv}
#: ${VALID_META:=/home/roseline/benit/DumpFongbefrall/valid/metadata_valid.csv}
: ${VALID_META:=/scratch/roseline/dump/DumpFongbefrall/valid/metadata_valid.csv}
...
ARGS+=" --use-reversal-classifier 0 "
...
PYTHONPATH='.'  python $DISTRIBUTED train_me_char.py $ARGS "$@"
