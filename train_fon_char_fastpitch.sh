...
: ${AMP:=false}
: ${SEED:=""}
#: ${CHECKPOINT_PATH:="/scratch/roseline/dump/DumpFongbefrall/fastpitchoutput/FastPitch_checkpoint_80.pt"}
#: ${VARIANT:=TACOTRON2}
: ${LEARNING_RATE:=0.01}
...
: ${DATASET_MAPPING:=/home/phifamin/benit/DumpFongbefrall/mapper_fonfr_char.json}
...
: ${TRAIN_META:=/home/phifamin/benit/DumpFongbefrall/train/metadata_train.csv}
: ${VALID_META:=/home/phifamin/benit/DumpFongbefrall/valid/metadata_valid.csv}
