...
: ${FASTPITCH:="/media/phifamin/DATA/mebenit/test2/train_fastspeech_mas/FastPitchMulti_checkpoint_180.pt"}
: ${BATCH_SIZE:=1}
#: ${PHRASES:="phrases/devset10.tsv"}
: ${OUTPUT_DIR:="/media/phifamin/DATA/mebenit/test2/fastpitchsofttest/"}
