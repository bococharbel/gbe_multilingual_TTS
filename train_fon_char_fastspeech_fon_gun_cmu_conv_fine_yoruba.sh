...
: ${OUTPUT_DIR:="/media/phifamin/DATA/mebenit/test2/train_fastspeech2_conv_fineyoruba"}
...
: ${AMP:=false}
: ${SEED:=""}
: ${CHECKPOINT_PATH:="/media/phifamin/DATA/mebenit/test2/train_fastspeech2_conv/FastSpeechModel_checkpoint_100.pt"}
...
: ${REMOVE_LANG_IDS:=fongbe,gengbe,gungbe,adjagbe}
