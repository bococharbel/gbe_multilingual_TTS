...
: ${OUTPUT_DIR:="/media/phifamin/DATA/mebenit/test2/train_fastspeech_conv_soft3_2yoruba"}
...
#: ${TRAIN_META:=/media/phifamin/DATA/mebenit/test2/metadata_fon_gun_yor_mina_cmu_train.csv}
: ${TRAIN_META:=/media/phifamin/DATA/mebenit/test2/metadata_yorubasmall_cmu_train.csv}
