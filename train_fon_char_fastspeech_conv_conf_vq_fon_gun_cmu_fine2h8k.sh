...
: ${OUTPUT_DIR:="/media/phifamin/DATA/mebenit/test2/train_fastspeech2_conv_conf_vq_fune_gungengbe_2h8k"}
...
: ${AMP:=false}
: ${SEED:=""}
: ${CHECKPOINT_PATH:="/media/phifamin/DATA/mebenit/test2/train_fastspeech2_conv_conf_vq/FastSpeechModelwavVq_checkpoint_150.pt"}
: ${VARIANT:=FASTSPEECHMODELWAVVQ}
: ${LEARNING_RATE:=0.01}
...
: ${TRAIN_META:=/media/phifamin/DATA/mebenit/test2/metadata_gengbe_gungbe_2h_8k_2_cmu_train.csv}
...
#: ${REMOVE_LANG_IDS:=fongbe,yoruba,gengbe,gungbe,adjagbe}
: ${REMOVE_LANG_IDS:=fongbe,yoruba}
...
#ARGS+=" --pitch-predictor-kernel-size 9"
#ARGS+=" --energy-predictor-kernel-size 9"
...
ARGS+=" --use-nemo-module "
#ARGS+=" --use-fastspeech2-module "
#ARGS+=" --use-mas  "
#ARGS+=" --no-load-pickle  "
#ARGS+=" --verbose  "
#ARGS+=" --use-sdtw  "
...
#ARGS+=" --checkpoint-path-sub  $CHECKPOINT_PATH_SUB "
