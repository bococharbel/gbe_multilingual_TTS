...
: ${OUTPUT_DIR:="/media/phifamin/DATA/mebenit/test2/train_fastspeech_conv_vq_soft3_conformer"}
...
: ${CHECKPOINT_PATH_SUB:="/media/phifamin/DATA/mebenit/test2/trainhifigan/FastPitchMultiwavVq_checkpoint_44.pt"}
#: ${VARIANT:=TACOTRON2}
: ${LEARNING_RATE:=0.01}
