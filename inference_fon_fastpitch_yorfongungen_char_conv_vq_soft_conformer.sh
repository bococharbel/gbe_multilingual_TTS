...
: ${TRAINDIR:="/media/phifamin/DATA/mebenit/test2/train_fastspeech_conv_vq_soft3_conformer"}
...
#: ${FASTPITCH:="$TRAINDIR/FastPitchMultiwavVq_checkpoint_230.pt"}
: ${FASTPITCH:="$TRAINDIR/FastPitchMultiwavVq_checkpoint_280.pt"}
: ${BATCH_SIZE:=1}
#: ${PHRASES:="phrases/devset10.tsv"}
: ${OUTPUT_DIR:="/media/phifamin/DATA/mebenit/test2/fastpitch-conv-vq-soft-outtest3_$TESTCASE/"}
