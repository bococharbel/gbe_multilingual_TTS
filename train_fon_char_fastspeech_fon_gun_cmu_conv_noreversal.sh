...
: ${OUTPUT_DIR:="/media/phifamin/DATA/mebenit/test2/train_fastspeech2_conv"}
...
: ${AMP:=false}
: ${SEED:=""}
#: ${CHECKPOINT_PATH:="/media/phifamin/DATA/mebenit/test2/trainoutput/FastPitchMulti_checkpoint_115.pt"}
