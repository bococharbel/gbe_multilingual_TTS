...
: ${FASTPITCH:="/media/phifamin/DATA/mebenit/test2/train_fastspeech_conv_vq_soft3/FastPitchMultiwavVq_checkpoint_175.pt"}
: ${BATCH_SIZE:=1}
#: ${PHRASES:="phrases/devset10.tsv"}
: ${OUTPUT_DIR:="/media/phifamin/DATA/mebenit/test2/fastpitch-conv-vq-soft-outtest3/"}
