...
### from https://github.com/rishikksh20/LightSpeech
...
def get_pitch(wav_data, mel, hop_size, audio_sample_rate):
    """
    ...
    _f0, t = pw.dio(wav_data.astype(np.double), audio_sample_rate,
                    frame_period=hop_size / audio_sample_rate * 1000)
    f0 = pw.stonemask(wav_data.astype(np.double), _f0, t, audio_sample_rate)  # pitch refinement
